...
`appName` <mark style="color:red;">*`string`*</mark>  
 *Описание*  

`appVersion` <mark style="color:red;">*`string`*</mark>  
 *Описание*  
...
`e` <mark style="color:red;">*`string`*</mark>  
 *Описание*  
...
`e` <mark style="color:red;">*`Exception`*</mark>  
 *Описание*  
...
`errorInfo` <mark style="color:red;">*`string`*</mark>  
 *Описание*  
...
`i` <mark style="color:red;">*`string`*</mark>  
 *Описание*  
...
`_param2` <mark style="color:red;">*`string`*</mark>  
 *Описание*  
